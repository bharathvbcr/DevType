...
echo "  - Checking GitPulse LCOV export contract..."
"${ROOT}/Scripts/test-export-lcov.sh"
echo "  - Checking draft publication and failure recovery..."
python3 "${ROOT}/Scripts/test-release-publication.py"
echo "  - Checking stress-runner evidence admission..."
python3 "${ROOT}/Scripts/test-stress-productivity.py"
