...
The release gate is `DEVTYPE_BENCH=1 DEVTYPE_SKIP_AUTO_CERT=1 ./Scripts/ci-local.sh`. This local run passed on commit `48eb01b` (Swift 6.3.3 / Xcode 26.6):
...
- `./Scripts/test.sh`: **2,797 tests executed; 2,797 passed, 0 failures**.
