...
public final class LocalizationManager: ObservableObject {
    ...
    private static func en() -> [String: String] {
        return [
            ...
            "status.secure.copyHelp": "Secure Input is active. Click %@, choose a secret, then press ⌘V in the password field. Typed expansion stays paused.",
    ...
    private static func ko() -> [String: String] {
        return [
            ...
            "status.paused": "일시정지",
            "status.secure": "보안 입력",
            "status.secure.copyHelp": "보안 입력이 활성화되어 있습니다. %@ 메뉴에서 비밀을 선택한 다음 암호 입력란에서 ⌘V를 누르세요. 입력 확장은 일시 정지된 상태로 유지됩니다.",
    ...
    private static func ja() -> [String: String] {
        return [
            ...
            "status.secure.copyHelp": "セキュア入力が有効です。%@ をクリックしてシークレットを選び、パスワード欄で ⌘V を押してください。入力による展開は一時停止したままです。",
