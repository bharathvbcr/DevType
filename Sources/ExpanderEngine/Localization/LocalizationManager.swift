...
public final class LocalizationManager: ObservableObject {
    ...
    private static func en() -> [String: String] {
        return [
            ...
            "prefs.voice.speechModels": "Speech Recognition Models",
            "prefs.voice.speechModels.hint": "Apple Speech is the only on-device recognizer currently connected to dictation. Voxtral and Fun-ASR files remain visible as local inventory, but cannot be used until a compatible runtime is integrated.",
            "prefs.voice.speechModels.source.system": "macOS",
            "prefs.voice.speechModels.source.local": "Local file",
            "prefs.voice.speechModels.status.ready": "Ready",
            "prefs.voice.speechModels.status.notInstalled": "Not installed · runtime unavailable",
            "prefs.voice.speechModels.status.stored": "Stored · runtime unavailable",
            "prefs.voice.speechModels.status.invalid": "Invalid file · runtime unavailable",
    ...
    private static func ko() -> [String: String] {
        return [
            ...
            "prefs.voice.speechModels": "음성 인식 모델",
            "prefs.voice.speechModels.hint": "현재 받아쓰기에 연결된 온디바이스 인식기는 Apple Speech뿐입니다. Voxtral 및 Fun-ASR 파일은 로컬 목록에 표시되지만 호환 런타임이 통합될 때까지 사용할 수 없습니다.",
            "prefs.voice.speechModels.source.system": "macOS",
            "prefs.voice.speechModels.source.local": "로컬 파일",
            "prefs.voice.speechModels.status.ready": "준비됨",
            "prefs.voice.speechModels.status.notInstalled": "설치되지 않음 · 런타임 사용 불가",
            "prefs.voice.speechModels.status.stored": "저장됨 · 런타임 사용 불가",
            "prefs.voice.speechModels.status.invalid": "잘못된 파일 · 런타임 사용 불가",
    ...
    private static func ja() -> [String: String] {
        return [
            ...
            "prefs.voice.speechModels": "音声認識モデル",
            "prefs.voice.speechModels.hint": "現在、音声入力に接続されているオンデバイス認識器は Apple Speech のみです。Voxtral と Fun-ASR のファイルはローカル一覧に表示されますが、互換ランタイムが統合されるまでは使用できません。",
            "prefs.voice.speechModels.source.system": "macOS",
            "prefs.voice.speechModels.source.local": "ローカルファイル",
            "prefs.voice.speechModels.status.ready": "使用可能",
            "prefs.voice.speechModels.status.notInstalled": "未インストール · ランタイム未対応",
            "prefs.voice.speechModels.status.stored": "保存済み · ランタイム未対応",
            "prefs.voice.speechModels.status.invalid": "無効なファイル · ランタイム未対応",
